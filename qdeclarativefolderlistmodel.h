...
//![class props]
    ...
    Q_PROPERTY(bool onRoot READ onRoot NOTIFY onRootChanged)
...
public:
    ...
    enum Roles { FileNameRole = Qt::UserRole+1, FilePathRole = Qt::UserRole+2, IS_Folder = Qt::UserRole+3 };
...
//![notifier]
    ...
    void rootFolderChanged(QUrl arg);

    void onRootChanged(bool arg);

public slots:
void refresh();
void setRootFolder(QUrl arg);
